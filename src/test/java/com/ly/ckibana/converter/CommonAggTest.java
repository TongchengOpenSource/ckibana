...
public class CommonAggTest extends CommonTest {
    ...
    public void testFiltersAndDateHistogramAgg() {
        ...
        String expectedSqls = "[\n" +
                "                \"SELECT toInt64((toUnixTimestamp64Milli(`@timestampDateTime`)) / 30000) as `3_@timestampDateTime`,count(1) as `3__ckCount`,count(1) as `s1:\\\"s1value1\\\"__ckCount` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697891550000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697890650000  ) AND ( (  `s1` like '%s1value1%' ) ) GROUP BY `3_@timestampDateTime` ORDER BY `3_@timestampDateTime` asc LIMIT 30000\",\n" +
                "                \"SELECT toInt64((toUnixTimestamp64Milli(`@timestampDateTime`)) / 30000) as `3_@timestampDateTime`,count(1) as `3__ckCount`,count(1) as `s2:\\\"s1value2\\\"__ckCount` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697891550000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697890650000  ) AND ( (  `s2` like '%s1value2%' ) ) GROUP BY `3_@timestampDateTime` ORDER BY `3_@timestampDateTime` asc LIMIT 30000\"\n" +
                "            ]";
    ...
    public void testDateHistogramAgg() {
        ...
        String expectedSqls = "[\n" +
                "                \"SELECT toInt64((toUnixTimestamp64Milli(`@timestampDateTime`)) / 30000) as `2_@timestampDateTime`,count(1) as `2__ckCount` FROM `table1_all` PREWHERE ( (  `s1` like '%s1value%' )  AND  (  `s1` like '%s1value%' ) ) AND ((  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697891630000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697890730000  )) GROUP BY `2_@timestampDateTime` ORDER BY `2_@timestampDateTime` asc LIMIT 30000\"\n" +
                "            ]";
    ...
    public void testTermsAgg() {
        ...
        String expectedSqls = "[\n" +
                "                \"SELECT `s1` as `2_s1`,count(1) as `2__ckCount` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697892100000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697891200000  ) AND (`2_s1` is not null AND `2_s1` != '' ) GROUP BY `2_s1` ORDER BY `2__ckCount` desc LIMIT 10\"\n" +
                "            ]";
    ...
    public void testMathAndPercentAndDateHistogramAgg() {
        ...
        String expectedSqls = "[\n" +
                "                \"SELECT SUM(`i1`) as `3_i1`,MIN(`i2`) as `4_i2`,MAX(`i3`) as `5_i3`,avg(`i1`) as `6_i1`,quantile(0.9)(`i1`) as `i1_90`,quantile(0.95)(`i1`) as `i1_95`,quantile(0.99)(`i1`) as `i1_99`,count(1) as `7__ckCount`,countIf(`i2` <= 100) as `i2_100`,count(1) as `8__ckCount`,toInt64((toUnixTimestamp64Milli(`@timestampDateTime`)) / 30000) as `2_@timestampDateTime`,count(1) as `2__ckCount` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697892150000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697891250000  ) GROUP BY `2_@timestampDateTime` ORDER BY `2_@timestampDateTime` asc LIMIT 30000\"\n" +
                "            ]";
    ...
    public void testRangeNumber() {
        ...
        String expectedSqls = " [\n" +
                "                \"SELECT countIf(`i1` >= 0 AND `i1` < 1000) as `0-1000`,countIf(`i1` >= 1000 AND `i1` < 2000) as `1000-2000`,countIf(`i1` >= 3000) as `3000-*` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697892540000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697891640000  ) AND (`i1` != 2147483647) LIMIT 30000\"\n" +
                "            ]";
    ...
    public void testCardinality() {
        ...
        String expectedSqls = "[\n" +
                "                \"SELECT countIf(`i1` >= 0 AND `i1` < 100) as `0-100`,countIf(`i1` >= 100 AND `i1` < 200) as `100-200`,countIf(`i1` >= 200 AND `i1` < 300) as `200-300` FROM `table1_all` PREWHERE (  toUnixTimestamp64Milli(`@timestampDateTime`) <= 1697892610000  AND  toUnixTimestamp64Milli(`@timestampDateTime`) >= 1697891710000  ) AND (`i1` != 2147483647) LIMIT 30000\"\n" +
                "            ]";
