...
@NoArgsConstructor
@Data
public class SumAggregation extends MathCategoryAggregation {

    public SumAggregation(AggsParam aggsParam) {
        super(aggsParam);
    }

    @Override
    public SumAggregation generate(AggsParam aggsParam) {
        return new SumAggregation(aggsParam);
    }

    @Override
    public List<SqlConverter> buildSelectSqlConvertors(Range timeRange) {
        return super.buildMathCategorySelectSql(SqlConstants.SUM);
    }
