...
@NoArgsConstructor
@Data
public class MinAggregation extends MathCategoryAggregation {

    public MinAggregation(AggsParam aggsParam) {
        super(aggsParam);
    }

    @Override
    public MinAggregation generate(AggsParam aggsParam) {
        return new MinAggregation(aggsParam);
    }

    @Override
    public List<SqlConverter> buildSelectSqlConvertors(Range timeRange) {
        return super.buildMathCategorySelectSql(SqlConstants.MIN);
    }
